...
public class Sighting {
    ...
    private final static Logger logr = Logger.getLogger(Sighting.class.getName());
    ...
    public boolean comparePlaces(double firstLatitude, double firstLongitude, double secondLatitude, double secondLongitude) {
        ...
        logr.info("latitude #1: " + firstLatitude + ", longitude #1 : " + firstLongitude + ", latitude #2 : " + secondLatitude + ", longitude #2 : " + secondLongitude + ".");
        logr.info(" distance: " + dist);
        return dist <= 5;
    }

    public boolean compareTimes(Date firstInstant, Date secondInstant) {
        logr.info("instant #1 : " + firstInstant + ", instant #2 : " + secondInstant + ".");
        logr.info(" dist: " + TimeUnit.MILLISECONDS.toMinutes(Math.abs(firstInstant.getTime() - secondInstant.getTime())) + " minutes");
